 ...
 */
public class ListSettingsPreferenceActivity extends AppCompatPreferenceActivity {

    private static final String KEY_LIST_ID = "list_id";
    private String mListID;

    public static Intent getIntent(Context packageContext, String listID) {
        Intent intent = new Intent(packageContext, ListSettingsPreferenceActivity.class);
    ...
    public void onHeaderClick(Header header, int position) {
        ...
        header.extras.putString(KEY_LIST_ID, mListID);
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            int id = item.getItemId();
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), ListSettingsPreferenceActivity.class));
                return true;
            }
